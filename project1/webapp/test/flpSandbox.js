		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#shellpluginproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"shellpluginproject1-display": {
								"semanticObject": "shellpluginproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=shellplugin.project1",
									"url": sap.ui.require.toUrl("shellplugin/project1")
								}
							}
						}
					}
